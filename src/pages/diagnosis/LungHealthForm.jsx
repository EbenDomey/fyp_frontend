...
import { defineFvcFev1 } from "../../utils/formulas";
import { Loader } from "../../components/Loader";
import { encryptDataAsymmetric } from "../../utils/encrypt";
...
export default function LungHealthForm() {
  ...
  const handleSubmit = async (event) => {
    ...
    const cipherText = encryptDataAsymmetric(formData);
  ...
  return (
    <Layout>
      <div className="m-auto w-9/10 formPage">
        <h2 className="text-2xl md:text-3xl bg-blue-900 text-white p-4 w-full">
          Lung Health Assessment
        </h2>
        <form onSubmit={handleSubmit} className="form-body">
          <h2 className="text-3xl p-4 border-2 border-white border-b-blue-900 rounded-md mb-4">
            Demographic Data
          </h2>
          <div className="ml-4 form-group w-full md:w-full">
          ...
          <div className="form-fields p-4 text-xl">
          ...
          <div className="p-4 text-xl">
            <h2 className="text-2xl md:text-3xl p-4 border-2 border-white border-b-blue-900 rounded-md mb-4">
          ...
          <button
            type="submit"
            className="form_submit inline-flex justify-center text-2xl"
          >
            Submit Form
